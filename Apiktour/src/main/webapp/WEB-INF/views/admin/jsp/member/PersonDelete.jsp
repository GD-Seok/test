...
<%
 ...
 boolean check = perMgr.PersonDelete(per);
 System.out.println("PersonDelete.jsp의 check : "+check);
%>
<html>
<head>
...
<body bgcolor="deepskyblue">
 ...
 <%
  if(check){// 회원삭제 성공시
   out.println("<b>회원삭제에 성공했습니다.</b><br>");
   out.println("<a href=05_admin_m_de.jsp>회원 삭제 페이지로</a>");
  }else{ out.println("<b>회원삭제에 실패했습니다. 다시 입력해주세요.</b><br>");
      out.println("<a href='05_admin_m_de.jsp'> 회원 삭제 페이지로 </a>");}
