...
<%
 ...
 boolean check = perMgr.PersonInsert(per);
 System.out.println("PersonInsert.jsp의 check : "+check);
%>
<html>
<head>
...
<body bgcolor="deepskyblue">
 ...
 <%
  if(check){// 회원가입 성공시
   out.println("<b>회원등록에 성공했습니다.</b><br>");
   out.println("<a href=05_admin_m_in.jsp>회원 등록 페이지로</a>");
  }else{ out.println("<b>회원등록에 실패했습니다. 다시 입력해주세요.</b><br>");
      out.println("<a href='05_admin_m_in.jsp'> 회원 등록 페이지로 </a>");}
